# Task HW03 
# Manipulate Raster Data and Produce Descriptive Statstics
# Compare Future Temp Scenarios (SSp1 vs SSp5) for Key Cities in one country 
# Years 2081-2100
...
# Lets Take The Max Value for each city in both maps
# and create a new tibble with the rows as cities and 2 columns for both maps
